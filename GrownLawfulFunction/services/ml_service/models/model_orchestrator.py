...
class ModelOrchestrator:
    ...
    async def predict(self, features: Dict[str, Any], match_id: str) -> Dict[str, Any]:
        ...
        # FIX: Do NOT apply an extra home-advantage bias here.
        # Bookmaker odds already fully price in home advantage; adding +4.5% home
        # probability on top causes systematic overconfidence in home-win predictions
        # (double-counting).  Individual models (Elo, BayesianNet, etc.) already
        # incorporate home-advantage in their own algorithms where appropriate.
        base_hp, base_dp, base_ap = mkt_hp, mkt_dp, mkt_ap
