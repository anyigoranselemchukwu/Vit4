...
const SAMPLE_ACHIEVEMENTS: Achievement[] = [
  { id: "first",        name: "First Blood",      description: "Make your first prediction",       icon: "🎯", earned: true,  rarity: "common"    },
  { id: "accuracy70",   name: "Sharpshooter",     description: "Reach 70% win rate",               icon: "🎖️", earned: true,  rarity: "rare"      },
  { id: "streak5",      name: "On Fire",           description: "Win 5 predictions in a row",       icon: "🔥", earned: false, rarity: "rare"      },
  { id: "prediction50", name: "Volume Player",     description: "Make 50 predictions",              icon: "📊", earned: false, rarity: "common"    },
  { id: "vitcoin1k",    name: "VIT Whale",         description: "Accumulate 1,000 VITCoin",         icon: "🐋", earned: false, rarity: "epic"      },
  { id: "validator",    name: "Network Defender",  description: "Become a validator",               icon: "🛡️", earned: false, rarity: "legendary" },
];
...
const SAMPLE_LEADERBOARD: LeaderboardEntry[] = [
  { rank: 1,  username: "QuantBettor",   xp: 4820, winRate: 0.79, level: "Elite"  },
  { rank: 2,  username: "EdgeHunter99",  xp: 4301, winRate: 0.76, level: "Elite"  },
  { rank: 3,  username: "TraderXVI",     xp: 3940, winRate: 0.74, level: "Elite"  },
  { rank: 4,  username: "SharpValue",    xp: 3210, winRate: 0.71, level: "Elite"  },
  { rank: 5,  username: "AIFollower",    xp: 2870, winRate: 0.69, level: "Pro"    },
  { rank: 6,  username: "Momentum7",     xp: 2340, winRate: 0.67, level: "Pro"    },
  { rank: 7,  username: "ClvMaster",     xp: 1980, winRate: 0.65, level: "Pro"    },
  { rank: 8,  username: "BankrollKing",  xp: 1540, winRate: 0.63, level: "Analyst"},
  { rank: 9,  username: "PickSurgeon",   xp: 1200, winRate: 0.61, level: "Analyst"},
  { rank: 10, username: "WinnerWinner",  xp: 890,  winRate: 0.58, level: "Analyst"},
];
