...
import {
  ...
  CreditCard, Home, Lock, LogOut, Menu, ShieldCheck,
  ShoppingBag, Shield, ArrowLeftRight, Trophy, Vote, X,
  TrendingUp, Layers, Bell,
} from "lucide-react";
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      ...
      {/* ── Desktop sidebar ──────────────────────────────── */}
      <div className="hidden md:flex w-64 bg-sidebar border-r border-sidebar-border flex-shrink-0 flex-col sticky top-0 h-screen">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-sidebar/95 backdrop-blur-md border-t border-sidebar-border">
